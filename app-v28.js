...
.afmenu{position:absolute;left:18.6%;top:14.7%;width:51%;height:66.5%;background:#050505;color:white;border:1px solid rgba(255,255,255,.45);overflow:hidden}
.afhead{height:20%;background:#6f256f;display:flex;align-items:center;padding-left:5%;font-weight:900;font-size:9pt}
.aflens{height:18%;display:flex;align-items:center;padding:0 5%;font-weight:900;font-size:5.45pt;background:#090909;border-bottom:1px solid #333;white-space:nowrap;overflow:hidden}
.afrow{height:31%;display:grid;grid-template-columns:10% 1fr 14%;align-items:center;border-bottom:1px solid #222}
.afrow .lbl,.afrow .val{text-align:center;font-size:9pt;font-weight:900}
.miniScale{position:relative;height:100%;display:flex;flex-direction:column;justify-content:center}
.miniNums{display:flex;justify-content:space-between;font-size:4.4pt;font-weight:900;margin-bottom:.8mm}
...
<div class="info">
  <div>
    ...
    <div class="infoRow"><b>Subject Distance:</b><span>${esc($('distance').value||'10')}m</span></div>
...
<div class="content">
  ...
  <div>
    <div class="block cameraBlock"><h3>Camera AF Microadjustment Settings</h3><div class="cameraArea"><img src="${esc(cameraSrc)}">${afMenuPrint(single,aw,at,lens)}</div><div class="caption">Settings shown after calibration.</div></div>
