...
.cameraBlock{height:70mm}.cameraArea{position:relative;height:62mm;overflow:hidden;background:#111}.cameraArea img{width:100%;height:100%;object-fit:contain;display:block;background:#111}
.afmenu{position:absolute;left:27%;top:20%;width:47%;height:67%;background:#050505;border:1px solid rgba(255,255,255,.4);color:white}.afhead{height:22%;background:#6f256f;padding:1.7mm;font-weight:700;font-size:9.5pt}.aflens{height:19%;font-weight:700;padding:1.4mm 1.8mm;font-size:6.7pt;border-bottom:1px solid #333;white-space:nowrap;overflow:hidden}.afrow{height:29%;display:grid;grid-template-columns:9mm 1fr 9mm;align-items:center;padding:0 1.5mm}.afrow>b{text-align:center;font-size:10.5pt}.scale{height:11mm;position:relative}.nums{display:flex;justify-content:space-between;font-size:5.7pt;margin-bottom:1mm}.rail{position:absolute;left:0;right:0;top:5.5mm;border-top:1px solid white;height:6mm}.tick{position:absolute;top:-1.8mm;height:3.5mm;border-left:1px solid white}.tick.major{top:-2.6mm;height:5mm}.tick.zero{top:-3.5mm;height:7mm;border-left-width:2px}.rail i{position:absolute;top:-5.5mm;transform:translateX(-50%);width:0;height:0;border-left:3px solid transparent;border-right:3px solid transparent;border-top:6px solid white}
